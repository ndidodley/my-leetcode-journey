...
From the onset you can be very inefficient by concatenating the two lists and using the sort method or you could folllow
the difficult path.

The second path I choose is iterating from **nums2** from the back to front, while changing the padded zeroes to numbers 
from nums2. Then finally sorting the **nums1**
